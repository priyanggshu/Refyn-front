...
import { Shield, Repeat, Activity, Radio, Archive, Mail, Sparkles, ArrowRight } from "lucide-react";

const FeaturesSection = () => {
  const [hoveredCard, setHoveredCard] = useState(null);
  
  // Feature cards data with enhanced descriptions and gradients
  const features = [
    {
      icon: <Sparkles size={24} />,
      title: "AI Schema Fixes",
      description: "Auto-healing database schema with ML-powered error detection. Review and approve AI suggestions with one click.",
      color: "#9a90da",
    ...
    },
    {
      ...
      description: "Seamlessly convert between PostgreSQL, MySQL, and MongoDB schemas with automatic type mapping and data transformation.",
      color: "#8a80d0",
    ...
    },
    {
      ...
      description: "Detailed operation logs with timestamps, error highlighting, and searchable history for comprehensive migration tracking.",
      color: "#7a70c6",
    ...
    },
    {
      ...
      description: "Live progress updates with millisecond precision. Monitor your data flow in real-time with visual batch processing indicators.",
      color: "#6a60bc",
    ...
    },
    {
      ...
      description: "One-click rollbacks with versioned database snapshots. Restore to any point in your migration history with confidence.",
      color: "#5a50b2",
    ...
    },
    {
      ...
      description: "Comprehensive migration reports with performance metrics, error analysis, and actionable insights delivered to your inbox.",
      color: "#4a40a8",
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        >
          <p className="text-[#9a90da] font-semibold font-Outfit bg-[#9a90da]/5 px-4 py-1.5 rounded-full border border-[#9a90da]/20">
            <span className="animate-pulse pr-1">✨</span> Features That Matter <span className="animate-pulse pl-1">✨</span>
          </p>
        </motion.div>
        ...
        >
          Not a list. <span className="bg-gradient-to-r from-[#9a90da] to-[#716aeb] text-transparent bg-clip-text">A vibe.</span>
        </motion.h2>
      ...
      >
        {features.map((feature, index) => (
          ...
          >
            ...
            {/* Card content */}
            <div className={`relative h-full bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 overflow-hidden transition-all duration-300 ${
              hoveredCard === index ? 'shadow-lg shadow-[#9a90da]/10 border-white/20' : ''
            }`}>
              {/* Feature icon */}
              <div className="relative mb-5 inline-block">
                <div className={`absolute -inset-3 rounded-full bg-gradient-to-r ${feature.lightGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
              ...
              <h3 className="text-white text-xl font-bold mb-3 font-Outfit transition-colors duration-300">
                <span className={`relative inline-block ${hoveredCard === index ? 'text-[#9a90da]' : ''}`}>
                  {feature.title}
                  {hoveredCard === index && (
                    <motion.div
                      layoutId="underline"
